...
const stripLeadingQuestionEnumeration = (text: string): string => text.replace(/^\d+\.\s*/, "").trim();
...
export const generatePdf = async (assignmentId: string, paper: GeneratedPaper): Promise<string> => {
